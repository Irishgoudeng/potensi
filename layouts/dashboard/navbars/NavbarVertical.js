	...
	return (
		<Fragment>
			<SimpleBar style={{ maxHeight: '100vh' }}>
				...
				<div className={`nav-scroller ${styles.logoContainer}`}>
					<Link href="/" className="navbar-brand">
						<Image src="/images/POTENSI-LOGO.png" alt="" className={styles.logoImage} />
					</Link>
				</div>
				{/* Dashboard Menu */}
				<Accordion
...
// 	return (
// 		<Fragment>
// 			<SimpleBar style={{ maxHeight: '250vh' }}>

// 				<div className="nav-scroller logo-container">
// 					<Link href="/" className="navbar-brand">
// 						<Image src="/images/POTENSI-LOGO.png" alt="" className="logo-image" />
// 					</Link>
// 				</div>
// 				{/* Dashboard Menu */}
// 				<Accordion
...
// // 					<Link href="/" className="navbar-brand">
// // 						<Image src="/images/POTENSI-LOGO.png" alt="" />
// // 					</Link>
// // 				</div>
// // 				{/* Dashboard Menu */}
// // 				<Accordion
